...
export const DATEVALUE = (date_text) => {
...
export const DAY = (serial_number) => {
...
export const DAYS = (end_date, start_date) => {
...
export const DAYS360 = (start_date, end_date, method) => {
...
export const EDATE = (start_date, months) => {
  start_date = utils.parseDate(start_date);
  if (start_date instanceof Error) {
    return start_date;
  }
...
export const EOMONTH = (start_date, months) => {
  start_date = utils.parseDate(start_date);
  if (start_date instanceof Error) {
    return start_date;
  }
...
export const HOUR = (serial_number) => {
...
export const MINUTE = (serial_number) => {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const MONTH = (serial_number) => {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const NETWORKDAYS = function (start_date, end_date, holidays) {
  return this.NETWORKDAYS.INTL(start_date, end_date, 1, holidays);
};

exports.NETWORKDAYS.INTL = (start_date, end_date, weekend, holidays) => {
  start_date = utils.parseDate(start_date);
  if (start_date instanceof Error) {
    return start_date;
  }
...
export const SECOND = (serial_number) => {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const TIME = (hour, minute, second) => {
...
export const TIMEVALUE = (time_text) => {
...
export const WEEKDAY = (serial_number, return_type) => {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const WEEKNUM = function (serial_number, return_type) {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const WORKDAY = function (start_date, days, holidays) {
  return this.WORKDAY.INTL(start_date, days, 1, holidays);
};

exports.WORKDAY.INTL = (start_date, days, weekend, holidays) => {
  start_date = utils.parseDate(start_date);
  if (start_date instanceof Error) {
    return start_date;
  }
...
export const YEAR = (serial_number) => {
  serial_number = utils.parseDate(serial_number);
  if (serial_number instanceof Error) {
    return serial_number;
  }
...
export const YEARFRAC = (start_date, end_date, basis) => {
  start_date = utils.parseDate(start_date);
  if (start_date instanceof Error) {
    return start_date;
  }
